...
const Menu = () => {
    ...
    //     // Inicijalizacija Isotope instance kada se komponenta montira
    //     isotope.current = new Isotope('.menu-container', {
    //         itemSelector: '.menu-item',
    //         layoutMode: 'fitRows'
    //     });

    //     // Čišćenje Isotope instance kada se komponenta demontira
    //     return () => isotope.current.destroy();
    // }, []);

    // useEffect(() => {
    //     if (isotope.current) {
    //         // Ažuriranje Isotope-a na osnovu aktivnog filtera
            ...
            <div className="container" data-aos="fade-up">
                ...
                <div className="row menu-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                    {filteredMenuItems.map(item => (
                        <div key={item.id} className={`col-lg-6 menu-item ${item.category}`}>
