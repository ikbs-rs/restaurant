...
const Menu = () => {
    ...
    const menuItems = [
        ...
        { id: 5, category: 'filter-specialty', name: 'Tuscan Grilled', price: '$9.95', img: 'assets/img/menu/tuscan-grilled.jpg', description: 'Grilled chicken with provolone, artichoke hearts, and roasted red pesto' },
...
<section id="menu" className="menu section-bg ">
            <div className="container" data-aos="fade-up">
                ...
                <div className="row menu-container" data-aos="fade-up" data-aos-delay="200">
                    {menuItems.map(item => (
                        <div key={item.id} className={`col-lg-4 menu-item ${item.category}`}>
